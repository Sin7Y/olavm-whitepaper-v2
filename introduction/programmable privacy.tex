...
Ola chose to implement a customize SCL to get programmability even through it's more harder to implement than DSL, because we could get benefits as follows:
 \begin{itemize}
