\begin{abstract} 
    We are building a ZK-ZKVM platform for Ethereum \cite{website:Ethereum} that will provide: 
...
Ola is a rapidly developing project. This version of the white paper will detail the design philosophy and design specifications of the full-featured zk-friendly ZKVM and dev-friendly 
    smart contract language Ola lang. Privacy-related implementation details will be released when the testnet is released. Update.
    
Key words: Privacy, Programmability, ZKVM, Smart contract, Data ownership    
\end{abstract}