...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.5\textwidth]{cur proof generation.jpg}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.5\textwidth]{delegable tx.jpg}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.5\textwidth]{our proof generation.jpg}
