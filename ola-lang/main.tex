\section{Ola-Lang: Dev-friendly Smart Contract Language}\label{sec:ola-lang}
...
\input{ola-lang/language-introduction}
\input{ola-lang/language-elements}
\input{ola-lang/grammar}
\input{ola-lang/smart-contract}