...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\textwidth]{GPU-The butterfly networks of Cooley-Tukey NTT.jpg}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\textwidth]{GPU-Implement of 2-D NTT with GPU.jpg}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\textwidth]{GPU-CUDA memory model.jpg}
