...
It matches ir insts opcode + operand pattern, then lower the matched pattern to target machine code insts.
...
Let's take the Conditional Branch, for example, it's target insts as follow:
\begin{table}[!ht]
    \resizebox{\textwidth}{!}{
